...
- (void)viewDidLoad {
    ...
    _header = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 1)];
    _header.backgroundColor = [UIColor colorWithRed:151/255.0 green:193/255.0 blue:235/255.0 alpha:1.0];
