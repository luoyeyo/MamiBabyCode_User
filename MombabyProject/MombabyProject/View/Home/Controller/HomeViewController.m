...
//        if (kUserInfo.isLogined) {
//            // 妈妈怀孕天数 服务器时间减去末次月经
//            _params.days = [NSString stringWithFormat:@"%d",[currentTimeStr getVipNumberDay:kUserInfo.lastMenses]];
//        } else {
...
- (void)setUIContent {
    ...
    self.baseViewHeight.constant = CGRectGetMaxY(self.middleBaseView.frame);
}
