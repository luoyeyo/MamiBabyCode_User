...
- (NSDate *)dayInTheFollowingMonth:(NSUInteger)month;//获取当前日期之后的几个月

- (NSDate *)dayInTheFollowingDay:(NSUInteger)day;//获取当前日期之后的几个天
...
//通过数字返回星期几
+(NSString *)getWeekStringFromInteger:(NSUInteger)week;
